...
Press the "Run" button to execute the code. Below the editor, you will see the the program output. It should say "Hello, World!"
...
Upload the `.py` file to the "Hello, World!" assignment in ThinkWave.
